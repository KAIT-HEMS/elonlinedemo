  ...
  <div class="camera-switcher card shadow d-grid">
    <template v-if="cameraViewType === 'diagram'">
        <svg width="566" height="312" style="height: 84%; width: 100%; margin-top: 4%" viewBox="0 0 566 312" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <text fill="#2D9E68" xml:space="preserve" style="white-space: pre" font-family="Rubik" font-size="14" letter-spacing="0em"><tspan x="400" y="248.59">{{propertyList['0xE4'] || '0 %'}}</tspan></text>
          ...
          <text fill="black" xml:space="preserve" style="white-space: pre" font-family="Rubik" font-size="10" letter-spacing="0em"><tspan x="506.336" y="219.425">{{propertyList['0xD3'] || '0 W'}}</tspan></text>
