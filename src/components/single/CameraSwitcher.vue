<template>
  <div class="camera-switcher card shadow d-grid">
    <template v-if="cameraViewType === 'diagram'">
      <svg width="798" height="325" viewBox="0 0 798 325" style="height: 84%; width: 100%; margin: auto;" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path id="ELline5" d="M629 224.5H627V228.5H629V224.5ZM797.069 155.241C797.754 154.374 797.607 153.116 796.741 152.431C795.874 151.746 794.616 151.893 793.931 152.759L797.069 155.241ZM629 228.5C653.802 228.5 680.644 229.519 708.83 220.849C737.104 212.152 766.602 193.764 797.069 155.241L793.931 152.759C763.898 190.736 735.052 208.598 707.654 217.026C680.167 225.481 654.009 224.5 629 224.5V228.5Z" fill="#FACC91"/>
        <path id="ELline1" d="M342.5 251.994H241.286C232.55 252.125 132 254.5 140.5 243.5C144 230 143 228.5 140.5 214.5C138.959 212.535 143.167 205.185 155.5 205.5" :stroke="(propertyList['0xC7'] === '0x40' || propertyList['0xC7'] === '0x41' || propertyList['0xC7'] === '0x42' || propertyList['0xC7'] === '0x43' || propertyList['0xC7'] === '0x44') ? 'orange' : 'grey'" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
        <path id="ELline2" d="M160.235 209.287L157 210V200L160.235 200.713C160.674 200.808 161 201.486 161 202.281V207.712C161 208.514 160.669 209.186 160.235 209.281V209.287Z" :fill="(propertyList['0xC7'] === '0x40' || propertyList['0xC7'] === '0x41' || propertyList['0xC7'] === '0x42' || propertyList['0xC7'] === '0x43' || propertyList['0xC7'] === '0x44') ? 'orange' : 'grey'"/>
        <path id="ELline3" d="M159 201V209C156.792 209 155 207.207 155 205C155 202.793 156.792 201 159 201Z" :fill="(propertyList['0xC7'] === '0x40' || propertyList['0xC7'] === '0x41' || propertyList['0xC7'] === '0x42' || propertyList['0xC7'] === '0x43' || propertyList['0xC7'] === '0x44') ? 'orange' : 'grey'"/>
        ...
        <path id="ELline4" d="M362.082 219.058C361.101 219.565 360.716 220.772 361.223 221.753C361.73 222.734 362.937 223.119 363.918 222.612L362.082 219.058ZM385.5 236.335L387.467 236.696L385.5 236.335ZM401 254.835L401.651 256.726L401 254.835ZM363.918 222.612C366.315 221.373 369.1 220.233 371.834 219.577C374.598 218.913 377.127 218.789 379.121 219.378C380.999 219.933 382.521 221.145 383.414 223.548C384.352 226.07 384.628 230.012 383.533 235.974L387.467 236.696C388.622 230.408 388.46 225.642 387.164 222.154C385.822 218.546 383.314 216.446 380.254 215.542C377.311 214.673 373.996 214.944 370.9 215.687C367.775 216.437 364.685 217.713 362.082 219.058L363.918 222.612ZM383.533 235.974C382.183 243.321 383.383 249.558 386.786 253.511C390.289 257.58 395.721 258.767 401.651 256.726L400.349 252.944C395.654 254.56 392.051 253.496 389.817 250.902C387.483 248.19 386.245 243.349 387.467 236.696L383.533 235.974ZM401.651 256.726C403.648 256.039 405.289 255.355 406.585 254.671C407.854 254.002 408.919 253.269 409.641 252.431C410.388 251.563 410.931 250.36 410.557 249.004C410.219 247.783 409.271 246.977 408.412 246.457C406.672 245.402 403.923 244.694 400.725 244.229C397.449 243.753 393.443 243.5 389 243.5V247.5C393.307 247.5 397.113 247.747 400.15 248.188C403.264 248.64 405.328 249.265 406.338 249.877C406.854 250.19 406.765 250.301 406.701 250.069C406.6 249.703 406.831 249.564 406.609 249.821C406.362 250.108 405.802 250.562 404.72 251.133C403.664 251.69 402.227 252.297 400.349 252.944L401.651 256.726Z" :fill="(propertyList['0xC7'] === '0x40' || propertyList['0xC7'] === '0x41' || propertyList['0xC7'] === '0x42' || propertyList['0xC7'] === '0x43' || propertyList['0xC7'] === '0x44') ? 'orange' : 'grey'"/>
        </g>
        </g>
        ...
        <circle id="Chargeable" cx="154" cy="124" r="8" :fill="(propertyList['0xC7'] === '0x41' || propertyList['0xC7'] === '0x43') ? 'green' : (propertyList['0xC7'] === '0x40' || propertyList['0xC7'] === '0x42') ? 'red' : 'grey'"/>
        <circle id="Dischargeable" cx="154" cy="146" r="8" :fill="(propertyList['0xC7'] === '0x42' || propertyList['0xC7'] === '0x43') ? 'green' : (propertyList['0xC7'] === '0x40' || propertyList['0xC7'] === '0x41') ? 'red' : 'grey'"/>
        </g>
