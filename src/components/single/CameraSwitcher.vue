<template>
  <div class="camera-switcher card shadow d-grid">
    ...
    <template v-else-if="cameraViewType === 'diagram_evcharger'">
      <div class="card flex-grow-1 d-grid grid-template-100" style="padding: 50px; border: none;">
        <svg width="798" height="325" viewBox="0 0 798 325" style="height: 100%; width: 100%;" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path id="ELline5" d="M794 154.5C772.5 179 749.4 227 627 227" :stroke="propertyList['0xE4'] ? 'orange' : '#bbbbbb'" stroke-width="6" stroke-linecap="round"/>
          <path id="ELline5" class="animate" v-show="propertyList['0xDA'] === '0x42'" d="M794 154.5C772.5 179 749.4 227 627 227" stroke-linejoin="round"/>
          ...
          <g id="ev-charger-diagram-battery">
            ...
            <text id="text1096" fill="#787676" xml:space="preserve" style="white-space: pre" font-family="Rubik" font-size="14" letter-spacing="0em"><tspan x="572" y="257.295">0%</tspan></text>
            <text id="text1100" fill="#787676" xml:space="preserve" style="white-space: pre" font-family="Rubik" font-size="14" letter-spacing="0em"><tspan x="572" y="166.295">100%</tspan></text>
            <path id="IdleButton" d="M500 225H424C419.582 225 416 228.582 416 233V249C416 253.418 419.582 257 424 257H500C504.418 257 508 253.418 508 249V233C508 228.582 504.418 225 500 225Z" :stroke="propertyList['0xDA'] === '0x47' ? 'white' : '#909090'" :fill="propertyList['0xDA'] === '0x47' ? '#3779F5' : 'white'"/>
            <text id="IdleText" :fill="propertyList['0xDA'] === '0x47' ? 'white' : '#7E7E7E'" xml:space="preserve" style="white-space: pre" font-family="Rubik" font-size="16" letter-spacing="0em"><tspan x="445" y="245.98">Idle</tspan></text>
            <path id="ChargeButton" d="M500.5 146H424.5C420.358 146 417 149.358 417 153.5V169.5C417 173.642 420.358 177 424.5 177H500.5C504.642 177 508 173.642 508 169.5V153.5C508 149.358 504.642 146 500.5 146Z" :stroke="propertyList['0xDA'] === '0x42' ? 'white' : '#909090'" :fill="propertyList['0xDA'] === '0x42' ? '#3779F5' : 'white'"/>
            <text id="ChargeText" :fill="propertyList['0xDA'] === '0x42' ? 'white' : '#7E7E7E'" xml:space="preserve" style="white-space: pre" font-family="Rubik" font-size="16" letter-spacing="0em"><tspan x="436" y="166.98">Charge</tspan></text>
            <path id="StandbyButton" d="M500.5 186H423.5C419.358 186 416 189.358 416 193.5V209.5C416 213.642 419.358 217 423.5 217H500.5C504.642 217 508 213.642 508 209.5V193.5C508 189.358 504.642 186 500.5 186Z" :stroke="propertyList['0xDA'] === '0x44' ? 'white' : '#909090'" :fill="propertyList['0xDA'] === '0x44' ? '#3779F5' : 'white'"/>
            <text id="StandbyText" :fill="propertyList['0xDA'] === '0x44' ? 'white' : '#7E7E7E'" xml:space="preserve" style="white-space: pre" font-family="Rubik" font-size="16" letter-spacing="0em"><tspan x="432" y="206.98">Standby</tspan></text>
