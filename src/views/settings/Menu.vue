  ...
  <div class="settings-menu">
    <div class="card-body d-grid gap-3 align-content-start">
      ...
      <div class="d-grid gap-3">
        ...
        <router-link :to="{ name: 'settings.evCharger' }" class="text-muted text-decoration-none" :class="{ active: section === 'evCharger' }">{{ text?.nav?.evCharger }}</router-link>
...
export default defineComponent({
  setup() {
    ...
    return {
      text: computed(() => store.getters.text?.settings?.menu),
